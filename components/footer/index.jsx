  ...
  return (
    <div className="bg-text-2 min-h-[27.5rem] h-fit mt-[8.75rem] pt-[5rem] pb-[1.5rem]">
      <ul className="relative grid grid-cols-12 container">
        ...
        <li className="col-span-12 sm:col-span-6 xl:col-span-3 min-w-[13.5625rem] mb-10 xl:mb-0 flex flex-col items-center xl:items-start gap-[1rem]">
        ...
        <li className="col-span-12 sm:col-span-6 xl:col-span-3 min-w-[10.9375rem] mb-10 xl:mb-0 flex flex-col items-center xl:items-start">
        ...
        <li className="col-span-12 sm:col-span-6 xl:col-span-2 min-w-[7.6875rem] mb-10 xl:mb-0 flex flex-col items-center xl:items-start">
          <div className="flex flex-col items-start gap-[1.5rem]">
        ...
        <li className="col-span-12 sm:col-span-6 xl:col-span-2 min-w-[6.8125rem] mb-10 xl:mb-0 flex flex-col items-center xl:items-start">
          <div className="flex flex-col items-start gap-[1.5rem]">
        ...
        <li className="col-span-12 sm:col-span-6 xl:col-span-2 min-w-[12.375rem] mb-10 lg:mb-0 flex flex-col items-center xl:items-start">
          <div className="flex flex-col items-start gap-[1.5rem]">
